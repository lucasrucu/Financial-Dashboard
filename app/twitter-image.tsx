/* Qori Twitter card image — Financial Dashboard.
   Identical to app/opengraph-image.tsx so Twitter cards use the same mark.
   Kept as a full copy (not a re-export) so Next.js recognizes the `runtime`
   string literal and the edge runtime resolves correctly. */

import { ImageResponse } from "next/og";

export const runtime = "edge";
export const alt = "Financial Dashboard";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const TITLE = "Financial Dashboard";
const SUBTITLE = "Multi-bank personal finance, in one place.";
