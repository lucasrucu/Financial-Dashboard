    ...
    return (
      <div className="mx-auto flex max-w-md flex-col items-center gap-3 rounded-xl border border-border bg-card px-6 py-8 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Thanks — I&apos;ll review your request and reach out at{" "}
          <span className="font-medium text-foreground">{email.trim()}</span> if it&apos;s a fit.
        </p>
      </div>
    );
  }
    ...
    >
      ...
      <label className="flex cursor-pointer items-start gap-2.5 text-sm text-muted-foreground">
        ...
        <span>
          ...
          and understand my financial data would be processed as described there.
        </span>
      </label>
